...
For ICD-9/ICD-9-CM and ATC clinical code hierarchies, see
[[file:MEDICAL_TRAINING.md][MEDICAL_TRAINING.md]] for end-to-end instructions on building edge lists and
training three separate embeddings for diagnoses, procedures, and medications.
